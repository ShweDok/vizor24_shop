...
@section('content')
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">Редактировать обращение</h3>
        </div>
        <div class="block-content block-content-full">
            <div class="row mr-5">
                ...
                <div class="col-lg-8 space-y-5 px-4">
                    ...
                    <form class="space-y-4" action="{{ route('app.tickets.update', ['id'=>0]) }}" method="POST">
                        @csrf
                        <div class="row mt-0">
                        ...
                        <div class="row">
                            ...
                            <textarea required class="form-control" id="message" name="message" rows="10" placeholder="Ваше обращение.."></textarea>
                        </div>

                        <div class="row">
                            <div class="ms-auto">
                                <button type="submit" class="btn btn-alt-primary">Сохранить изменения</button>
                            </div>
                        </div>
