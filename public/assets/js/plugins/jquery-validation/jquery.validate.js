...
// https://jqueryvalidation.org/jQuery.validator.format/
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            equalTo: "Пожалуйста введите правильно значение.",
            maxlength: $.validator.format("Введите не больше {0} символов."),
            minlength: $.validator.format("Введите не меньше {0} символов."),
            rangelength: $.validator.format("Введите значение длинной между {0} и {1} символами."),
            ...
            step: $.validator.format("Введите значение соответствующее шагу {0}.")
        },
